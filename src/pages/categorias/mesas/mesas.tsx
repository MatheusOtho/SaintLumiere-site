        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 relative z-10 pt-16">
          ...
          >
            ...
            <p className="text-zinc-300 text-xs sm:text-sm max-w-md mx-auto font-normal leading-relaxed">
              Encontre mesas de alta qualidade com design exclusivo, perfeitas para áreas de lazer, espaços comerciais, condomínios e ambientes externos.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          {itensMesas.map((Mesas, idx) => (
            ...
            >
              ...
              <Link
                ...
                aria-label={`Ver detalhes de ${Mesas.name}`}
              >
                <img
                  src={Mesas.img}
                  alt={Mesas.name}
